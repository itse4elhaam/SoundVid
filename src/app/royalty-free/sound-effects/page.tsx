...
import MusicLibrary from "src/components/Music Library/MusicLibrary";
	...
	totalSlides: [
		{
			name: "A random one",
			title: "Water",
			imgSrc: "https://images.unsplash.com/photo-1691860664006-b1ef531c8743?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=387&q=80",
		},
		{
			name: "A random one",
			title: "Water",
			...
			<section className='-z-10 flex h-[40vh] items-center justify-center bg-[url("https://www.videvo.net/images/banners/sound-effects.jpg")] bg-cover bg-center bg-no-repeat'>
				<div className="container mx-auto text-center font-bold">
					...
					<p className="text-white text-md font-light ">
						Blockbuster movie-quality royalty free sound effects to
