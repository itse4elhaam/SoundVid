...
export default function Footer() {
	return (
		<footer className="bg-[#1d262d] relative bottom-0">
			<div className="container mx-auto flex flex-col justify-center px-3 py-3 pt-6 text-[#657a89] lg:flex-row lg:space-x-1">
				<div className="space-y-2px-4 mb-6 justify-center space-y-2 text-center lg:w-2/5 lg:text-left">
					<h2 className="text-center text-xl font-bold text-white lg:text-left">
						About Lorem
					</h2>
					<p className="text-sm">
						Lorem ipsum dolor sit amet, consectetur adipisicing
						elit. Cum id necessitatibus consequatur praesentium
						molestias aliquam alias, aspernatur perferendis,
						possimus illo animi! Et sapiente voluptatum sit,
						molestiae corrupti quisquam perspiciatis! Omnis,
						mollitia in. <br />
						<br />
						If you have any suggestions for the site, or would like
				...
				<div className="mx-auto mb-6 flex flex-col space-y-2 lg:w-2/5">
					<div className="mx-auto flex flex-col space-y-2 md:pl-3">
						<h2 className="flex justify-center text-xl font-bold text-white lg:justify-start">
							Quick Links
						</h2>
				...
				<div className="space-y-2 lg:text-left">
					...
					<p className="text-center text-sm lg:text-left">
						For recent updates and news follow our social media feed
					</p>
